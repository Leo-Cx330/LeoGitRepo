 ...
 * FileName: Leo-cloud
 * Author:   lihao
 * Date:     2019/8/30 3:22 PM
 * Description: 解决 RedisConnection.set([B[B)V问题  conn.set ==>conn.stringCommands().set()
 * author: leo
 */
public class ExtRedisTokenStore implements TokenStore {
    ...
    public ExtRedisTokenStore(RedisConnectionFactory connectionFactory) {
