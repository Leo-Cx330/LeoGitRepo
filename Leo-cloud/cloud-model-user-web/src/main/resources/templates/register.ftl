...
<body>
	<div class="ny-header">
		<div class="nb">
			<div class="logo">
				<a href="index.ftl"><img src="static/images/logo.png" alt="" /></a>
				<span>&middot; 欢迎注册</span>
			</div>
			<div class="right">
				<span>我已经注册，马上</span> <a href="login.ftl" class="blue">登录 &gt;</a>
			</div>
		</div>
	</div>
	<div class="nb">
				...
				<div class="form-box">
					<form action="register" method="post">
						<div class="input-box input-box1 onfocusstyle cloudUser-word">
							<label for="username" class="icon-cloudUser"></label> <input
