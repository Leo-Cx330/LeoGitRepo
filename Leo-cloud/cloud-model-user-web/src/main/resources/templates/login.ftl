...
<body
	...
	<div class="nb">
			...
			<div class="right">
				<div class="form-box">
					...
					<form action="login" method="post">
						...
						<div class="bind">
							<a href="./register.ftl" class="blue">注册账号</a>
						</div>
						<div class="input-box input-box1 onfocusstyle cloudUser-word">
							<label for="loginname" class="icon-cloudUser"></label> <input
					...
					<div class="hezuo oauth">
						...
						<ul>
							...
							<li><a href="jumpQQlogin" class="qq">QQ</a></li>
		...
		<div class="ny-footer">
			<div class="link">
				...
				| <a href="/cloudUser.html">会员中心</a> | <a href="/n-help.html">帮助中心</a>
			</div>
			<div class="copyright">
				<p>
				<p>
	...
	<script>
		...
		if ((navigator.userAgent.indexOf('MSIE') >= 0 && navigator.userAgent
			...
			$(".cloudUser-word").append("<span>用户名</span>");
